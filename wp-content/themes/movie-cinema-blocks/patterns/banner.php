...
<div class="wp-block-columns"><!-- wp:column {"width":"10%","backgroundColor":"accent"} -->
<div class="wp-block-column has-accent-background-color has-background" style="flex-basis:10%"><!-- wp:paragraph {"align":"center","textColor":"background","className":"red-header-text","fontSize":"upper-heading","fontFamily":"lexend-deca"} -->
...
<!-- wp:column {"verticalAlignment":"center","width":"60%","style":{"spacing":{"padding":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80","top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}}} -->
<div class="wp-block-column is-vertically-aligned-center" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--80);flex-basis:60%"><!-- wp:paragraph {"textColor":"accent","fontSize":"upper-heading","fontFamily":"lexend-deca"} -->
...
<!-- wp:heading {"style":{"typography":{"fontSize":"50px","fontStyle":"normal","fontWeight":"800","lineHeight":"1.4"},"color":{"text":"#2b2b35"}},"fontFamily":"lexend-deca"} -->
<h2 class="wp-block-heading has-text-color has-lexend-deca-font-family" style="color:#2b2b35;font-size:50px;font-style:normal;font-weight:800;line-height:1.4">'. esc_html('Exerience The Magic','movie-cinema-blocks') .'<br>'. esc_html('Of Cinema With Us','movie-cinema-blocks') .'</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-background-color has-accent-background-color has-text-color has-background wp-element-button">'. esc_html('EXPLORE MORE','movie-cinema-blocks') .'</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
