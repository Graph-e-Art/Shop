...
<div class="wp-block-group has-background-color has-text-color has-background has-link-color" style="background-color:#2b2b35"><!-- wp:columns {"style":{"spacing":{"padding":{"top":"50px","bottom":"50px","right":"20px","left":"20px"}}},"className":"alignwide"} -->
...
<p class="has-text-align-left has-lexend-deca-font-family has-small-font-size"><span class="dashicons dashicons-email-alt"></span>  '. esc_html('support123@example.com','movie-cinema-blocks') .'</p>
<!-- /wp:paragraph -->
