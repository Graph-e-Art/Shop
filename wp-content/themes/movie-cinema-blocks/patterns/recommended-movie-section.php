...
<div class="wp-block-cover" style="border-radius:20px;min-height:50px"><span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-60 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-6" alt="" src="'.esc_url(get_template_directory_uri()) .'/assets/images/heading-image.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","fontSize":"content-heading"} -->
<h2 class="wp-block-heading has-text-align-center has-content-heading-font-size">'. esc_html('Recommended Movies','movie-cinema-blocks') .'</h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
