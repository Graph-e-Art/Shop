...
function movie_cinema_blocks_admin_notice_site_demo() {
    ?>
    <div class="notice notice-success is-dismissible " style="display: flex; padding: 10px;">
        ...
        <a style="margin-left: 30px;" class=" button button-primary " href="<?php echo esc_url( admin_url( 'themes.php?page=movie-cinema-blocks' )); ?>" ><?php esc_html_e( 'Getting Started', 'movie-cinema-blocks' ) ?></a>
    </div>
    <?php
}
add_action( 'admin_notices', 'movie_cinema_blocks_admin_notice_site_demo' );
